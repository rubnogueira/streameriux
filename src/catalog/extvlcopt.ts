...
export type ExtVlcOptCategory = "http" | "playback" | "av" | "mpegts" | "dvb" | "sout" | "other";
...
export const EXTVLCOPT_CATALOG: readonly ExtVlcOptCatalogEntry[] = [
  // HTTP / network (IPTV must-have)
  {
    ...
    type: "string",
    category: "http",
    meaning: "HTTP User-Agent header",
    supported: true,
  },
  {
    name: "http-referrer",
    type: "url",
    category: "http",
    meaning: "HTTP Referer header (VLC spelling: referrer)",
    supported: true,
  },
  {
    name: "http-reconnect",
    type: "bool",
    category: "http",
    meaning: "Reconnect HTTP streams on drop",
    supported: false,
  },
  {
    name: "http-user",
    type: "string",
    category: "http",
    meaning: "HTTP basic auth username",
    supported: true,
  },
  {
    name: "http-pwd",
    type: "string",
    category: "http",
    meaning: "HTTP basic auth password",
    supported: true,
  },
  {
    name: "http-proxy",
  ...
  },
  {
    ...
    type: "bool",
    category: "http",
    meaning: "Forward cookies on HTTP requests",
    supported: false,
  },
  {
    name: "http-caching",
  ...
  },
  {
    ...
    type: "ms",
    category: "http",
    meaning: "Network cache (ms, VLC 2+)",
    supported: false,
  },
  {
    name: "file-caching",
  ...
  },
  {
    ...
    type: "bool",
    category: "http",
    meaning: "RTSP interleaved over TCP",
    supported: false,
  },
  {
    ...
    type: "int",
    category: "http",
    meaning: "RTSP frame buffer (bytes)",
    supported: false,
  },
  {
    name: "rtsp-user",
  ...
  },
  {
    ...
    type: "string",
    category: "http",
    meaning: "HTTP bind/host override",
    supported: false,
  },
  ...
  },
  {
    ...
    type: "int",
    category: "playback",
    meaning: "Repeat count (-1 = forever)",
    supported: false,
  },
  {
    name: "input-slave",
    type: "url",
    category: "playback",
    meaning: "Extra audio/subs input URL",
    supported: false,
  },
  {
    name: "input-title-format",
    type: "string",
    category: "playback",
    meaning: "Title format string",
    supported: false,
  },
  {
    name: "bookmarks",
  ...
  },
  {
    ...
    type: "int",
    category: "playback",
    meaning: "Clock reference average",
    supported: false,
  },
  {
    name: "network-synchronisation",
    type: "bool",
    category: "playback",
    meaning: "Network synchronisation",
    supported: false,
  },
  {
    name: "file-cat",
    type: "bool",
    category: "playback",
    meaning: "Play truncated files (legacy)",
    supported: false,
  },
  ...
  { name: "no-video", type: "bool", category: "av", meaning: "Disable video", supported: false },
  {
    ...
    type: "int",
    category: "av",
    meaning: "0-based audio track index",
    supported: false,
  },
  {
    name: "audio-track-id",
  ...
  },
  {
    ...
    type: "csv",
    category: "av",
    meaning: "Preferred audio languages",
    supported: false,
  },
  {
    name: "audio-desync",
  ...
  },
  {
    ...
    type: "int",
    category: "av",
    meaning: "0-based video track index",
    supported: false,
  },
  {
    name: "video-track-id",
  ...
  },
  {
    ...
    type: "int",
    category: "av",
    meaning: "0-based subtitle track index",
    supported: false,
  },
  {
    name: "sub-track-id",
  ...
  },
  {
    ...
    type: "string",
    category: "av",
    meaning: "External subtitle path",
    supported: false,
  },
  {
    name: "sub-language",
    type: "csv",
    category: "av",
    meaning: "Preferred subtitle languages",
    supported: false,
  },
  {
    name: "sub-autodetect-file",
    type: "bool",
    category: "av",
    meaning: "Autodetect sidecar subtitles",
    supported: false,
  },
  {
    name: "sub-delay",
    type: "float",
    category: "av",
    meaning: "Subtitle delay (seconds)",
    supported: false,
  },
  {
    name: "sub-fps",
    type: "float",
    category: "av",
    meaning: "Subtitle FPS (0 = default)",
    supported: false,
  },
  {
    name: "subsdec-encoding",
    type: "string",
    category: "av",
    meaning: "Subtitle charset",
    supported: false,
  },
  {
    name: "subsdec-align",
    type: "int",
    category: "av",
    meaning: "Subtitle alignment",
    supported: false,
  },
  {
    name: "freetype-rel-fontsize",
    type: "int",
    category: "av",
    meaning: "Relative subtitle font size",
    supported: false,
  },
  ...
  // MPEG-TS
  {
    ...
    type: "int",
    category: "mpegts",
    meaning: "MPEG-TS program (PMT) number",
    supported: false,
  },
  {
    name: "programs",
    type: "csv",
    category: "mpegts",
    meaning: "Multiple MPEG-TS program numbers",
    supported: false,
  },
  {
    name: "ts-es-id-pid",
  ...
  },
  {
    ...
    type: "bool",
    category: "mpegts",
    meaning: "Split elementary streams",
    supported: false,
  },
  {
  ...
  },
  {
    ...
    type: "int",
    category: "mpegts",
    meaning: "TS output MTU",
    supported: false,
  },
  {
    name: "sout-ts-pid-video",
    type: "int",
    category: "mpegts",
    meaning: "Fixed video PID (sout)",
    supported: false,
  },
  {
    name: "sout-ts-pid-audio",
    type: "int",
    category: "mpegts",
    meaning: "Fixed audio PID (sout)",
    supported: false,
  },
  {
    name: "sout-ts-pid-spu",
    type: "int",
    category: "mpegts",
    meaning: "Fixed SPU PID (sout)",
    supported: false,
  },
  {
    name: "sout-ts-pid-pmt",
    type: "int",
    category: "mpegts",
    meaning: "Fixed PMT PID (sout)",
    supported: false,
  },
  {
    name: "sout-ts-es-id-pid",
    type: "bool",
    category: "mpegts",
    meaning: "Sout PID = ES id",
    supported: false,
  },
  {
    name: "sout-ts-dts-delay",
    type: "ms",
    category: "mpegts",
    meaning: "DTS delay (sout)",
    supported: false,
  },
  ...
  },
  {
    ...
    type: "int",
    category: "dvb",
    meaning: "DVB frontend/device index",
    supported: false,
  },
  {
    name: "dvb-frequency",
    type: "int",
    category: "dvb",
    meaning: "Tuner frequency (Hz/kHz per system)",
    supported: false,
  },
  {
    name: "dvb-bandwidth",
  ...
  },
  {
    ...
    type: "int",
    category: "dvb",
    meaning: "DiSEqC satellite number",
    supported: false,
  },
  { name: "dvb-tone", type: "int", category: "dvb", meaning: "22 kHz tone", supported: false },
  {
    ...
    type: "int",
    category: "dvb",
    meaning: "Forward error correction",
    supported: false,
  },
  {
    name: "dvb-modulation",
  ...
  },
  {
    ...
    type: "ms",
    category: "dvb",
    meaning: "Desktop capture cache (ms)",
    supported: false,
  },
  {
    name: "screen-left",
    type: "int",
    category: "dvb",
    meaning: "Capture rectangle left",
    supported: false,
  },
  {
    name: "screen-top",
  ...
  },
  {
    ...
    type: "int",
    category: "dvb",
    meaning: "Capture rectangle width",
    supported: false,
  },
  {
    name: "screen-height",
    type: "int",
    category: "dvb",
    meaning: "Capture rectangle height",
    supported: false,
  },
  {
    ...
    type: "int",
    category: "dvb",
    meaning: "fake:// image reload interval",
    supported: false,
  },
  ...
  },
  {
    ...
    type: "bool",
    category: "sout",
    meaning: "Keep sout open across items",
    supported: false,
  },
  {
    name: "sout-all",
  ...
  },
  {
    ...
    type: "string",
    category: "sout",
    meaning: "Sout destination",
    supported: false,
  },
  {
    name: "sout-mux-caching",
    type: "ms",
    category: "sout",
    meaning: "Sout mux cache (ms)",
    supported: false,
  },
  {
    ...
    type: "ms",
    category: "sout",
    meaning: "Sout UDP cache (ms)",
    supported: false,
  },
  {
    name: "sout-rtp-caching",
    type: "ms",
    category: "sout",
    meaning: "Sout RTP cache (ms)",
    supported: false,
  },
  {
    name: "sout-livehttp-caching",
    type: "bool",
    category: "sout",
    meaning: "Sout live HTTP caching",
    supported: false,
  },
] as const;
...
export function applyExtVlcOpts(target: VlcOptTarget, opts: readonly ParsedExtVlcOpt[]): void {
  ...
  else if (target.vlcOptions && Object.keys(target.vlcOptions).length === 0)
    target.vlcOptions = undefined;
}
