  ...
  return (
    <div style={{ flexGrow: 1, minHeight: 0, display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      >
        ...
        >
          <text style={{ fontSize: 12, fontFamily: FONT, fontWeight: "600", color: C.onAccent }}>
            Add
          </text>
        </div>
      </div>
      ...
      {rows.length === 0 ? (
        ...
        >
          <text style={{ fontSize: 13, fontFamily: FONT, color: C.tertiary }}>
            No groups yet — add a custom group above
          </text>
        </div>
      ) : (
        <WindowedList
          ...
          renderRow={(index) => {
            ...
            return (
              ...
              >
                ...
                <text
                  style={{ fontSize: 11, fontFamily: FONT, color: C.ghost }}
                >{`${row.count} ch`}</text>
                {row.custom ? (
                  <IconButton
                    icon="trash"
