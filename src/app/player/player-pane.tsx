...
export function PlayerPane({
  ...
  const channelMeta =
    channel?.group ??
    (channel?.country ? countryLabel(channel.country.split(';')[0] ?? '') : channel ? basename(channel.sourceFile) : '')
    ...
    >
      ...
      >
        ...
        {state.status === 'idle' || state.status === 'error' ? (
          ...
          >
            ...
            <text testId="player-empty" style={{ fontSize: 14, fontFamily: FONT, color: C.tertiary }}>
              {state.status === 'error' ? (state.error ?? 'Could not open this stream') : 'Select a channel to play'}
            </text>
          </div>
          ...
          >
            <Spinner />
            <text testId="player-empty" style={{ fontSize: 12, fontFamily: FONT, color: C.secondary }}>
              Opening stream…
            </text>
          </div>
        ) : null}
      ...
      >
          ...
          {epgEnabled && channel ? (
            ...
            >
              <text style={{ fontSize: 11, fontFamily: FONT, fontWeight: '600', color: C.secondary }}>Guide</text>
            </div>
          ) : null}
          <div
      ...
      <PlayerChromeOverlay edge="bottom" visible={showChrome} fullscreen={fullscreen}>
          {state.error ? (
            ...
            <text style={{ fontSize: 12, fontFamily: FONT, color: C.secondary }}>{state.warning}</text>
          ) : null}
          ...
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            {state.live ? (
              ...
              >
                ...
                />
                <text style={{ fontSize: 11, fontFamily: FONT, fontWeight: '600', color: nearLive ? C.live : C.secondary }}>
                  LIVE
                </text>
              </div>
            ) : null}
