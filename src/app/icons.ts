...
import { inlineSvgMarkup } from "../lib/svg-source";

function mapIcons<const T extends Record<string, string>>(icons: T): T {
  return Object.fromEntries(
    Object.entries(icons).map(([name, source]) => [name, inlineSvgMarkup(source)]),
  ) as T;
}
